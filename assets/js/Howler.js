window.sfx = {
    ...
    fear: new Howl({
        src: [
            'assets/music/fear.mp3'
        ],
        // volume: 0.5
    }),

    levelUpLoop: new Howl({
        src: [
            'assets/music/level-up-loop.mp3'
        ],
        volume: 0.5,
        loop: true
    }),

    levelUpLoopEnd: new Howl({
        src: [
            'assets/music/level-up-loop-end.mp3'
        ],
        // volume: 0.5
    }),
